...
%%% The first variable is a Non-Gaussian Random Field (Rank Asymmetry) %%%  
%%% The second variable is a Non-Gaussian Random Field (Rank Asymmetry) %%%  
...
param.rangeX{1,1} = [10 230]/3; param.rangeX{1,2}=[10 190]/1.8634;
param.rangeX{2,1} = model{1,2}; param.rangeX{2,2}=[10 190]/4;
